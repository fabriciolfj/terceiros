...
public class TransactionControllerV2 {
    ...
    @ApiOperation(value = "API para criar uma transação financeira", response = TransactionDTO.class, consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE, authorizations = {@Authorization(value = "coffeeandit", scopes = {@AuthorizationScope(scope = "SCOPE_CoffeeAndITRole", description = "Role para consumo")})}
    )
    ...
    @ApiOperation(value = "API para alterar a situação de transação financeira", authorizations = {@Authorization(value = "coffeeandit", scopes = {@AuthorizationScope(scope = "SCOPE_CoffeeAndITRole", description = "Role para consumo")})})
    ...
    @ApiOperation(value = "API para buscar os transações persistidas por agência e conta", authorizations = {@Authorization(value = "coffeeandit", scopes = {@AuthorizationScope(scope = "SCOPE_CoffeeAndITRole", description = "Role para consumo")})})
    ...
    public Mono<TransactionDTO> findById(@RequestHeader(name = "Authorization") String bearerToken, @PathVariable("id") String uuid, @RequestHeader(name = "content-type", defaultValue = MediaType.APPLICATION_JSON_VALUE) String contentType) {
